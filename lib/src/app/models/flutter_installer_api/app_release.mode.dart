...
class AppRelease {
  ...
  factory AppRelease.fromJson(String source) => AppRelease.fromMap(json.decode(source));

  @override
  String toString() => 'AppRelease(name: $name, version: $version, downloadLinks: $downloadLinks)';
